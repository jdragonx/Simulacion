...
public:
    ...
    void getHeatMapColor(double value){ //Un valor entre 0 y 1
...
public:
    ...
    double *eRs;             //Energía especular recibida en el receptor
    double *eRd;             //Energía difusa recibida en el receptor
    ...
    double solidAngle(point b){
        double area=0;
        double dst = Module(p - b);
        double r_rp=ReceptionRadius*0.2/dst;
        area = PI*r_rp*r_rp;
        return area;
    }
